...
**Note** that the following functions are to be used while following the Mesh guide on how to use your Smart Contract with Mesh. Here we just list all the endpoint functions for this particular Smart Contract.
